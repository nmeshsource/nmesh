...
/* add crc02 of len nbytes2 to crc01 (of len ntotalbytes), write combined
   CRC into crc01 and let ntotalbytes += nbytes2
   In: crc01, ntotalbytes, crc02, nbytes2
   OUT: crc01, ntotalbytes */
