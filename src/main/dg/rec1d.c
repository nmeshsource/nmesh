                           ...
                           double u_scale, double s1, double s2)
{
  ...
  if(forward) /* weight w0 for linear interpolation*/
    w0 = c0;
  else        /* weight w0 for linear extrapolation*/
    w0 = 1./c0;
...
*/
  ...
  /* use w0 and w1 to extrapolate or interpolate u */
  return w0*u[i0] + w1*u[i0in1];
}
