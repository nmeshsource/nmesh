...
int nmesh_center(tMesh *mesh)
{
  ...
  AddPar("center0_y", "0", "y-coord of center0"); // KEEP these
  AddPar("center0_z", "0", "z-coord of center0"); //
  AddPar("center1_x", "0", "x-coord of center1"); // center pars in
  AddPar("center1_y", "0", "y-coord of center1"); //
  AddPar("center1_z", "0", "z-coord of center1"); // this particular
  AddPar("center2_x", "0", "x-coord of center2"); //
  AddPar("center2_y", "0", "y-coord of center2"); // order !!!
